...
processed_data_file = "./processed_s21_data_70Vbg_normalized.npz"

normfile = TdmsFile(folder_path + f"\\SA40515J.20240123.000100.tdms")
...
if os.path.exists(processed_data_file):
    ...
    for file_name in tqdm(file_list, desc="Processing files"):
        ...
        re_s21_norm = normfile["Data.000000"]["ReS21"].data
        im_s21_norm = normfile["Data.000000"]["ImS21"].data

        # Normalize the S21 data at high field
        S21_normalized = (re_s21 + 1j * im_s21) / (re_s21_norm + 1j * im_s21_norm)


        # Compute log magnitude of S21 in dB
        magnitude_S21_normalized = np.abs(S21_normalized)
        log_mag_s21 = 20 * np.log10(magnitude_S21_normalized)
