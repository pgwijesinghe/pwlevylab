...
corresponding_power = powers[min_value_index[0]]  # min_value_index[1] corresponds to the power axis

print(f"Minimum S21 value: {min_value} dB")
print(f"Power corresponding to the minimum S21 value: {corresponding_power} dBm")
